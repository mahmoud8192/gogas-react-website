...
import OurstoryItem from "../components/About us/OurstoryItem";
import VerticalSlider from "../components/About us/VerticalSlider";
import InfoContainer from "../components/About us/InfoContainer";
...
function AboutUs() {
  const style = {
    base: "w-full flex flex-col gap-35",
    our_story_base: "w-full h-200 max-h-[80vh] flex relative",
    main: "flex flex-col gap-50 w-[80%] max-w-[2000px] mx-auto h-fit",
    title:
      "w-fit h-fit[font-family:var(--font-main)] font-bold text-[1.5rem] leading-[1.8rem] ",

    scrollableContainer:
      "w-[90%] h-full  flex flex-col gap-8  overflow-y-scroll scrollbar  scrolscrollbar-none ",
    scrollable: "px-2"
  };
  // fet current path name for Ease Access component
    ...
    <div className={style.base}>
      ...
      <div className={style.main}>
        <div className="w-full h-fit flex flex-col gap-8">
          ...
          <div className={style.our_story_base}>
            <VerticalSlider
            ...
            <div ref={scrollableWrapEl} className={style.scrollableContainer}>
